...
bool loadMedia()
{
	...
	gPNGSurface2 = loadSurface("06_extension_libraries_and_loading_other_image_formats/83.png");
	if (gPNGSurface == NULL || gPNGSurface2 == NULL)
	{
	...
	else
	{
		...
		else
		{
			...
			while (!quit)
			{
				...
				stretchRect.w = SCREEN_WIDTH / 2;
				stretchRect.h = SCREEN_HEIGHT / 2;
				SDL_BlitScaled(gPNGSurface2, NULL, gScreenSurface, &stretchRect);
